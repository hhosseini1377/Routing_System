...
TP_MISTRAL="${TP_MISTRAL:-4}"
TP_VICUNA="${TP_VICUNA:-4}"
TP_YI="${TP_YI:-4}"

TH_MISTRAL="${TH_MISTRAL:-30}"
TH_VICUNA="${TH_VICUNA:-30}"
TH_YI="${TH_YI:-40}"
...
# Empty = omit --w-ema-decay (no EMA; matches main.py default). Use e.g. 0.99 to smooth w.
...
OPTIMIZE_BETA_METHOD="${OPTIMIZE_BETA_METHOD:-bisection}"
